:Title: Release Notes for OGC I3S Community Standard version 1.1
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Approval Date:   2020-01-dd
|Publication Date:   2020-mm-dd
|Reference URL for this OGC(R) document: http://www.opengis.net/doc/RN/I3S/1.1
|Internal reference number of this OGC(R) document:    19-034r1
